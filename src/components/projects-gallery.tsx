...
const projects = [
    ...
    },
    {
        ...
        shortName: 'Puri',
        img: 'https://mir-s3-cdn-cf.behance.net/project_modules/1400/38de92213297753.67439bf6e51c8.jpg',
                    ...
                    {projects.map((project) => {
                        ...
                        return (
                            <Link 
                                ...
                                className={`relative rounded-2xl overflow-hidden cursor-pointer group transition-all duration-[600ms] ${isActive ? 'flex-[5]' : 'flex-[1]'}`}
                ...
                <div className="flex md:hidden flex-col gap-4">
                    {projects.map((project, index) => (
                        ...
                        >
                            <Link 
                                href={project.link}
                                className="relative block h-[200px] rounded-2xl overflow-hidden group"
                            >
                                <img 
                                    alt={project.title}
